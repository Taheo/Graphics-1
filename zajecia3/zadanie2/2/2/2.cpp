...
// tekstura "têcza" o szerokoœci 512 tekseli
...
// tekstura "têcza" o szerokoœci 256 tekseli
...
// tekstura "têcza" o szerokoœci 128 tekseli
...
// tekstura "têcza" o szerokoœci 64 tekseli
...
// tekstura "têcza" o szerokoœci 32 tekseli
...
// tekstura "têcza" o szerokoœci 16 tekseli
...
// tekstura "têcza" o szerokoœci 8 tekseli
...
// tekstura "têcza" o szerokoœci 4 tekseli
...
// tekstura "têcza" o szerokoœci 2 tekseli
...
// tekstura "têcza" o szerokoœci 1 teksela
...
void DisplayScene()
{
	...
	// usuniêcie b³êdów przy renderingu brzegu tekstury
...
void GenerateDisplayLists()
{
	...
	// lista wyœwietlania - pierwsza "têcza"
	glNewList(SPECTRUM_1_LIST, GL_COMPILE);

	// definiowanie tekstury i mipmap
	//glTexImage1D(GL_TEXTURE_1D, 4, GL_RGB, 512, 0, GL_RGB, GL_UNSIGNED_BYTE, spectrum_512);
	...
	//glTexImage1D(GL_TEXTURE_1D, 0, GL_RGB, 1, 0, GL_RGB, GL_UNSIGNED_BYTE, spectrum_1);

	glTexImage1D(GL_TEXTURE_1D, 0, GL_RGB, 32, 0, GL_RGB, GL_UNSIGNED_BYTE, spectrum_32);
	// od³¿enie macierzy modelowania na stos
	glPushMatrix();
	...
	// lista wyœwietlania - druga "têcza"
	glNewList(SPECTRUM_2_LIST, GL_COMPILE);

	// definiowanie tekstury ³¹cznie z mipmapami
	gluBuild1DMipmaps(GL_TEXTURE_1D, GL_RGB, 32, GL_RGB, GL_UNSIGNED_BYTE, spectrum_32);
	...
	// lista wyœwietlania - trzecia "têcza"
	...
	// wy³¹czenie automatycznego generowania mipmap
